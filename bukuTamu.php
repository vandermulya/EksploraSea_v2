...
<head>
    ...
    <link rel="stylesheet" href="style/styleBuTam.css">
</head>
...
<body>
    ...
    <div class="container">
        <div class="container-top">
            <h1 class="title" style="margin: 95px 416px; font-size: 80px;">BUKU TAMU</h1>
        </div>
    ...
    <footer>
        <div class="jam_digital" id="jam_digital">
            ...
            <h3 style="color: #f7ede2; align-content: center; margin: 26px 0; margin-left: 465px;">Copyright &copy;<script>
                    document.write(new Date().getFullYear());
                </script>
                EksploraSea by
                Vander Mulya</h3>
            <a href="https://github.com/vandermulya/"><i class="fab fa-github" style="margin: 0 5px;"></i></a>
            <a href="https://www.instagram.com/vandermulya/"><i class="fab fa-instagram" style="margin: 0 45px;"></i></a>
            <a href="https://www.linkedin.com/in/vandermulya"><i class="fab fa-linkedin" style="margin: 0 85px;"></i></a>
